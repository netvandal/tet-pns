...
public class Menu implements Serializable 
{
	...
	public Menu(String t,String[] op)//costruttore del men˘
	{
		titolo=t;
		opzioni=op;
	...
	//viene settata la larghezza della colonna come la lunghezza dell'opzione pi˘ lunga
	...
	public void stampa()
	{
		stampaIntestazione();//stampa l'intestazione del men˘
	...
	//stampa l'intestazione del men˘
	public void stampaIntestazione()
	{
		//viene stampato un separatore in base alla largheza della colonna
		System.out.println(aggiungiSimbolo(SEPARATORE,larghezzaColonna));
		//viene stampato il titolo del men˘ centrato nella colonna
		System.out.println(formattaStringhe(titolo,larghezzaColonna,true));
		//viene stampato un altro separatore
		System.out.println(aggiungiSimbolo(SEPARATORE,larghezzaColonna));
	}
	
	//stampa il men˘ permette di effettuare una scelta fra le ozioni
	public int scelta()
	{
		stampa();
		return Service.leggiInt("Scelta",1,opzioni.length);
	}
